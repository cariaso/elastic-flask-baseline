...
def getStringToSign(formHiddenInputs,
    ...
    fieldtext = "&".join(['%s=%s' % (key, safequote(
        formHiddenInputs[key])) for key in formHiddenInputNames])
...
def getPayNowWidgetForm(
    amount, description, referenceId=None, immediateReturn=None, returnUrl=None, abandonUrl=None,
    ...
    formHiddenInputs['signature'] = fpsconn._auth_handler.sign_string(
        stringToSign)
